...
def main():
    ...
    random_losing_squares()
    prepare_game()
    game_squares(num1, num2, num3)
    winning_msg(v1, v2, v3, v4, h1, h2, h3, h4)
    losing_msg(v1, v2, v3, v4, h1, h2, h3, h4)

    win.getMouse()
    

def prepare_game():
    global v1, v2, v3, v4, h1, h2, h3, h4
    global win
...
def game_squares(num1, num2, num3):
...
def losing_msg(v1, v2, v3, v4, h1, h2, h3, h4):
...
def winning_msg(v1, v2, v3, v4, h1, h2, h3, h4):
